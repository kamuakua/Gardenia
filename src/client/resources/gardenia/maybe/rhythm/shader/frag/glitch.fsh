...
const float glitchAmplitude = 0.05; // increase this, default: 0.2
const float glitchNarrowness = 4.0; // default: 4.0
const float glitchBlockiness = 2.0;// default: 2.0
...
void mainImage( out vec4 fragColor, in vec2 fragCoord )
{
    ...
    fragColor = vec4(f, colROpacity * colGOpacity * colBOpacity * Opacity);
}
